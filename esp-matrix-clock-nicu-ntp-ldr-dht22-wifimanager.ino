...
// ver.1 - add DHT sensor for temperature and humidity
// ver.1.a - change at add text to be more easy to change 
// ver.2 - change temperature to be as float
// ver.3 - add increase/decrease brightness for day/night & verify NTP time at every hour + work as clock without wifi network (reconnect)
// ver.3d - add led for indicate syncronisation with NTP server
// ver.3e - change brightness using photoresistor (at NodeMCU: +3V3----LDR----A0(ADC)----|==10k==|------GND )
// ver.3.1 - verify quick the light level
// ver.3.2 - add full name of the days and the months, just in romanian language
...
#define anzMAX     4      // Anzahl der kaskadierten Module
...
DHT dht(DHTPIN, DHTTYPE, 18); // for ESP8266
